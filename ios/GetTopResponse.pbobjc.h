 ...
 **/
@interface GetTopResponseRoot : GPBRootObject
@end

#pragma mark - GetTopResponse

typedef GPB_ENUM(GetTopResponse_FieldNumber) {
  GetTopResponse_FieldNumber_BaseResponse = 1,
  GetTopResponse_FieldNumber_UsersArray = 4,
};

@interface GetTopResponse : GPBMessage
...
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<UserDetail*> *usersArray;
