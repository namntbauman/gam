 ...
 **/
@interface GiftCodeResponseRoot : GPBRootObject
@end

#pragma mark - GiftCodeResponse

typedef GPB_ENUM(GiftCodeResponse_FieldNumber) {
  GiftCodeResponse_FieldNumber_BaseResponse = 1,
  GiftCodeResponse_FieldNumber_Cash = 4,
  GiftCodeResponse_FieldNumber_IsGold = 5,
  GiftCodeResponse_FieldNumber_CaptchaToken = 6,
  GiftCodeResponse_FieldNumber_Captcha = 7,
  GiftCodeResponse_FieldNumber_VariantArray = 8,
};

@interface GiftCodeResponse : GPBMessage
