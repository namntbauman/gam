 ...
 **/
@interface RegMiniPokerResponseRoot : GPBRootObject
@end

#pragma mark - RegMiniPokerResponse

typedef GPB_ENUM(RegMiniPokerResponse_FieldNumber) {
  RegMiniPokerResponse_FieldNumber_BaseResponse = 1,
  RegMiniPokerResponse_FieldNumber_TimeQuay = 4,
  RegMiniPokerResponse_FieldNumber_Hu = 5,
  RegMiniPokerResponse_FieldNumber_IsGold = 7,
};
...
@property(nonatomic, readwrite) int32_t timeQuay;
