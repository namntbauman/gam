...
#pragma mark - ServerPingRequestRoot_FileDescriptor

static GPBFileDescriptor *ServerPingRequestRoot_FileDescriptor(void) {
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[ServerPingRequest class]
                                     rootClass:[ServerPingRequestRoot class]
                                          file:ServerPingRequestRoot_FileDescriptor()
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(ServerPingRequest__storage_)
