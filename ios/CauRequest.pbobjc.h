 ...
 **/
@interface CauRequestRoot : GPBRootObject
@end

#pragma mark - CauRequest

typedef GPB_ENUM(CauRequest_FieldNumber) {
  CauRequest_FieldNumber_BaseReq = 1,
  CauRequest_FieldNumber_ZoneId = 10,
  CauRequest_FieldNumber_LevelId = 11,
  CauRequest_FieldNumber_TableIndex = 12,
  CauRequest_FieldNumber_MatchId = 13,
};

@interface CauRequest : GPBMessage
