 ...
 **/
@interface RealTimeTaiSuuResponseRoot : GPBRootObject
@end

#pragma mark - RealTimeTaiSuuResponse

typedef GPB_ENUM(RealTimeTaiSuuResponse_FieldNumber) {
  RealTimeTaiSuuResponse_FieldNumber_BaseResponse = 1,
  RealTimeTaiSuuResponse_FieldNumber_Reference = 4,
