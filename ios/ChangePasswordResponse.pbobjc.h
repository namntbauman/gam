 ...
 **/
@interface ChangePasswordResponseRoot : GPBRootObject
@end

#pragma mark - ChangePasswordResponse

typedef GPB_ENUM(ChangePasswordResponse_FieldNumber) {
  ChangePasswordResponse_FieldNumber_BaseResponse = 1,
};
