 ...
 **/
@interface ReplyRequestRoot : GPBRootObject
@end

#pragma mark - ReplyRequest

typedef GPB_ENUM(ReplyRequest_FieldNumber) {
  ReplyRequest_FieldNumber_BaseReq = 1,
  ReplyRequest_FieldNumber_ZoneId = 10,
  ReplyRequest_FieldNumber_LevelId = 11,
  ReplyRequest_FieldNumber_TableIndex = 12,
  ReplyRequest_FieldNumber_MatchId = 13,
  ReplyRequest_FieldNumber_IsAccept = 14,
};

@interface ReplyRequest : GPBMessage
...
@property(nonatomic, readwrite) BOOL isAccept;
