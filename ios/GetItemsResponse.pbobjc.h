...
typedef GPB_ENUM(GetItemsResponse_FieldNumber) {
  GetItemsResponse_FieldNumber_BaseResponse = 1,
  GetItemsResponse_FieldNumber_ItemsArray = 4,
};
...
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<ItemEntity*> *itemsArray;
