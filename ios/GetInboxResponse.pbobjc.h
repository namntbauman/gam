 ...
 **/
@interface GetInboxResponseRoot : GPBRootObject
@end

#pragma mark - GetInboxResponse

typedef GPB_ENUM(GetInboxResponse_FieldNumber) {
  GetInboxResponse_FieldNumber_BaseResponse = 1,
  GetInboxResponse_FieldNumber_MessagesArray = 4,
};
...
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<MessageEntity*> *messagesArray;
