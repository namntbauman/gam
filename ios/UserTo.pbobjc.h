 ...
 **/
@interface UserToRoot : GPBRootObject
@end

#pragma mark - UserTo

typedef GPB_ENUM(UserTo_FieldNumber) {
  UserTo_FieldNumber_UserId = 1,
  UserTo_FieldNumber_TypeTo = 2,
...
@property(nonatomic, readwrite) int64_t callMoney;
