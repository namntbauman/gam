 ...
 **/
@interface BuyCardResponseRoot : GPBRootObject
@end

#pragma mark - BuyCardResponse

typedef GPB_ENUM(BuyCardResponse_FieldNumber) {
  BuyCardResponse_FieldNumber_BaseResponse = 1,
  BuyCardResponse_FieldNumber_Serial = 5,
  BuyCardResponse_FieldNumber_Pin = 6,
  BuyCardResponse_FieldNumber_Gold = 7,
};

@interface BuyCardResponse : GPBMessage
