 ...
 **/
@interface BetBaccaratRequestRoot : GPBRootObject
@end

#pragma mark - BetBaccaratRequest

typedef GPB_ENUM(BetBaccaratRequest_FieldNumber) {
  BetBaccaratRequest_FieldNumber_BaseReq = 1,
  BetBaccaratRequest_FieldNumber_IsGold = 15,
  BetBaccaratRequest_FieldNumber_Reference = 16,
  BetBaccaratRequest_FieldNumber_BetMoney = 17,
  BetBaccaratRequest_FieldNumber_BetsArray = 18,
};

@interface BetBaccaratRequest : GPBMessage
...
@property(nonatomic, readwrite) int64_t betMoney;
