 ...
 **/
@interface InitCardResponseRoot : GPBRootObject
@end

#pragma mark - InitCardResponse

typedef GPB_ENUM(InitCardResponse_FieldNumber) {
  InitCardResponse_FieldNumber_BaseResponse = 1,
  InitCardResponse_FieldNumber_CaptchaToken = 5,
  InitCardResponse_FieldNumber_Captcha = 6,
  InitCardResponse_FieldNumber_VariantArray = 7,
};

@interface InitCardResponse : GPBMessage
