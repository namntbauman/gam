 ...
 **/
@interface CauResponseRoot : GPBRootObject
@end

#pragma mark - CauResponse

typedef GPB_ENUM(CauResponse_FieldNumber) {
  CauResponse_FieldNumber_BaseResponse = 1,
  CauResponse_FieldNumber_Cau = 4,
  CauResponse_FieldNumber_History = 5,
  CauResponse_FieldNumber_ZoneId = 6,
  CauResponse_FieldNumber_TableIndex = 7,
  CauResponse_FieldNumber_MatchId = 8,
};

@interface CauResponse : GPBMessage
