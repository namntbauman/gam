 ...
 **/
@interface BaoSamResponseRoot : GPBRootObject
@end

#pragma mark - BaoSamResponse

typedef GPB_ENUM(BaoSamResponse_FieldNumber) {
  BaoSamResponse_FieldNumber_BaseResponse = 1,
  BaoSamResponse_FieldNumber_ZoneId = 4,
  BaoSamResponse_FieldNumber_TableIndex = 5,
