 ...
 **/
@interface CardResponseRoot : GPBRootObject
@end

#pragma mark - CardResponse

typedef GPB_ENUM(CardResponse_FieldNumber) {
  CardResponse_FieldNumber_BaseResponse = 1,
  CardResponse_FieldNumber_Cash = 4,
  CardResponse_FieldNumber_IsGold = 5,
  CardResponse_FieldNumber_CaptchaToken = 6,
  CardResponse_FieldNumber_Captcha = 7,
  CardResponse_FieldNumber_VariantArray = 8,
};

@interface CardResponse : GPBMessage
