 ...
 **/
@interface InviteRequestRoot : GPBRootObject
@end

#pragma mark - InviteRequest

typedef GPB_ENUM(InviteRequest_FieldNumber) {
  InviteRequest_FieldNumber_BaseReq = 1,
  InviteRequest_FieldNumber_ZoneId = 10,
  InviteRequest_FieldNumber_LevelId = 11,
  InviteRequest_FieldNumber_TableIndex = 12,
  InviteRequest_FieldNumber_MatchId = 13,
  InviteRequest_FieldNumber_DestId = 14,
};

@interface InviteRequest : GPBMessage
