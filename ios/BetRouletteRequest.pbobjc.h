 ...
 **/
@interface BetRouletteRequestRoot : GPBRootObject
@end

#pragma mark - BetRouletteRequest

typedef GPB_ENUM(BetRouletteRequest_FieldNumber) {
  BetRouletteRequest_FieldNumber_BaseReq = 1,
  BetRouletteRequest_FieldNumber_IsGold = 15,
  BetRouletteRequest_FieldNumber_Reference = 16,
  BetRouletteRequest_FieldNumber_BetsArray = 17,
};

@interface BetRouletteRequest : GPBMessage
