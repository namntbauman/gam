 ...
 **/
@interface TaiSuuResponseRoot : GPBRootObject
@end

#pragma mark - TaiSuuResponse

typedef GPB_ENUM(TaiSuuResponse_FieldNumber) {
  TaiSuuResponse_FieldNumber_BaseResponse = 1,
  TaiSuuResponse_FieldNumber_Reference = 4,
  TaiSuuResponse_FieldNumber_Cash = 5,
  TaiSuuResponse_FieldNumber_IsGold = 6,
};

@interface TaiSuuResponse : GPBMessage
