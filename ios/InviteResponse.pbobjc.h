 ...
 **/
@interface InviteResponseRoot : GPBRootObject
@end

#pragma mark - InviteResponse

typedef GPB_ENUM(InviteResponse_FieldNumber) {
  InviteResponse_FieldNumber_BaseResponse = 1,
  InviteResponse_FieldNumber_ZoneId = 4,
  InviteResponse_FieldNumber_LevelId = 5,
  InviteResponse_FieldNumber_TableIndex = 6,
  InviteResponse_FieldNumber_MatchId = 7,
  InviteResponse_FieldNumber_Source = 8,
};

@interface InviteResponse : GPBMessage
...
@property(nonatomic, readwrite, strong, null_resettable) Player *source;
