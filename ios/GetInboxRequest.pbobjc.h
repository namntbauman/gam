 ...
 **/
@interface GetInboxRequestRoot : GPBRootObject
@end

#pragma mark - GetInboxRequest

typedef GPB_ENUM(GetInboxRequest_FieldNumber) {
  GetInboxRequest_FieldNumber_BaseReq = 1,
};

@interface GetInboxRequest : GPBMessage
