 ...
 **/
@interface UpdateUserRequestRoot : GPBRootObject
@end

#pragma mark - UpdateUserRequest

typedef GPB_ENUM(UpdateUserRequest_FieldNumber) {
  UpdateUserRequest_FieldNumber_BaseReq = 1,
  UpdateUserRequest_FieldNumber_DisplayName = 10,
};

@interface UpdateUserRequest : GPBMessage
