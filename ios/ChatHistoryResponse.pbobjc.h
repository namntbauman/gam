 ...
 **/
@interface ChatHistoryResponseRoot : GPBRootObject
@end

#pragma mark - ChatHistoryResponse

typedef GPB_ENUM(ChatHistoryResponse_FieldNumber) {
  ChatHistoryResponse_FieldNumber_BaseResponse = 1,
  ChatHistoryResponse_FieldNumber_ChatsArray = 4,
};

@interface ChatHistoryResponse : GPBMessage
