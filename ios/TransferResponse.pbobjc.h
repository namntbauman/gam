 ...
 **/
@interface TransferResponseRoot : GPBRootObject
@end

#pragma mark - TransferResponse

typedef GPB_ENUM(TransferResponse_FieldNumber) {
  TransferResponse_FieldNumber_BaseResponse = 1,
  TransferResponse_FieldNumber_Cash = 4,
  TransferResponse_FieldNumber_IsGold = 5,
  TransferResponse_FieldNumber_CaptchaToken = 6,
  TransferResponse_FieldNumber_Captcha = 7,
  TransferResponse_FieldNumber_VariantArray = 8,
};
