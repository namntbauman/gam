 ...
 **/
@interface InitTransferLukResponseRoot : GPBRootObject
@end

#pragma mark - InitTransferLukResponse

typedef GPB_ENUM(InitTransferLukResponse_FieldNumber) {
  InitTransferLukResponse_FieldNumber_BaseResponse = 1,
  InitTransferLukResponse_FieldNumber_CaptchaToken = 5,
  InitTransferLukResponse_FieldNumber_Captcha = 6,
  InitTransferLukResponse_FieldNumber_VariantArray = 7,
};

@interface InitTransferLukResponse : GPBMessage
