 ...
 **/
@interface ConfirmRewardRequestRoot : GPBRootObject
@end

#pragma mark - ConfirmRewardRequest

typedef GPB_ENUM(ConfirmRewardRequest_FieldNumber) {
  ConfirmRewardRequest_FieldNumber_BaseReq = 1,
  ConfirmRewardRequest_FieldNumber_Otp = 12,
  ConfirmRewardRequest_FieldNumber_Token = 13,
  ConfirmRewardRequest_FieldNumber_TxnId = 14,
  ConfirmRewardRequest_FieldNumber_ItemId = 15,
};

@interface ConfirmRewardRequest : GPBMessage
