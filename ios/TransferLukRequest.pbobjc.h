 ...
 **/
@interface TransferLukRequestRoot : GPBRootObject
@end

#pragma mark - TransferLukRequest

typedef GPB_ENUM(TransferLukRequest_FieldNumber) {
  TransferLukRequest_FieldNumber_BaseReq = 1,
  TransferLukRequest_FieldNumber_Cash = 10,
  TransferLukRequest_FieldNumber_MatchId = 11,
  TransferLukRequest_FieldNumber_CaptchaToken = 12,
  TransferLukRequest_FieldNumber_Variant = 13,
};

@interface TransferLukRequest : GPBMessage
