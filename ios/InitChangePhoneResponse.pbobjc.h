 ...
 **/
@interface InitChangePhoneResponseRoot : GPBRootObject
@end

#pragma mark - InitChangePhoneResponse

typedef GPB_ENUM(InitChangePhoneResponse_FieldNumber) {
  InitChangePhoneResponse_FieldNumber_BaseResponse = 1,
  InitChangePhoneResponse_FieldNumber_ForgetToken = 5,
  InitChangePhoneResponse_FieldNumber_TxnId = 6,
  InitChangePhoneResponse_FieldNumber_URL = 7,
};

@interface InitChangePhoneResponse : GPBMessage
