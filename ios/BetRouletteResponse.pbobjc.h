 ...
 **/
@interface BetRouletteResponseRoot : GPBRootObject
@end

#pragma mark - BetRouletteResponse

typedef GPB_ENUM(BetRouletteResponse_FieldNumber) {
  BetRouletteResponse_FieldNumber_BaseResponse = 1,
  BetRouletteResponse_FieldNumber_YourBet = 4,
  BetRouletteResponse_FieldNumber_TotalBet = 5,
  BetRouletteResponse_FieldNumber_IsGold = 6,
  BetRouletteResponse_FieldNumber_BetsArray = 8,
};

@interface BetRouletteResponse : GPBMessage
