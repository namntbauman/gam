 ...
 **/
@interface ConfirmForgetSecretPwdRequestRoot : GPBRootObject
@end

#pragma mark - ConfirmForgetSecretPwdRequest

typedef GPB_ENUM(ConfirmForgetSecretPwdRequest_FieldNumber) {
  ConfirmForgetSecretPwdRequest_FieldNumber_BaseReq = 1,
