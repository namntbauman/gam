 ...
 **/
@interface GetTopRequestRoot : GPBRootObject
@end

#pragma mark - GetTopRequest

typedef GPB_ENUM(GetTopRequest_FieldNumber) {
  GetTopRequest_FieldNumber_BaseReq = 1,
  GetTopRequest_FieldNumber_IsGold = 10,
};

@interface GetTopRequest : GPBMessage
