 ...
 **/
@interface AnPhomRequestRoot : GPBRootObject
@end

#pragma mark - AnPhomRequest

typedef GPB_ENUM(AnPhomRequest_FieldNumber) {
  AnPhomRequest_FieldNumber_BaseReq = 1,
  AnPhomRequest_FieldNumber_ZoneId = 10,
  AnPhomRequest_FieldNumber_LevelId = 11,
  AnPhomRequest_FieldNumber_TableIndex = 12,
  AnPhomRequest_FieldNumber_MatchId = 13,
  AnPhomRequest_FieldNumber_Card = 14,
};

@interface AnPhomRequest : GPBMessage
