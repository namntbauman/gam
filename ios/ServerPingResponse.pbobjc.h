 ...
 **/
@interface ServerPingResponseRoot : GPBRootObject
@end

#pragma mark - ServerPingResponse

typedef GPB_ENUM(ServerPingResponse_FieldNumber) {
  ServerPingResponse_FieldNumber_BaseResponse = 1,
  ServerPingResponse_FieldNumber_ServerTime = 4,
};

@interface ServerPingResponse : GPBMessage
