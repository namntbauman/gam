 ...
 **/
@interface ChatRequestRoot : GPBRootObject
@end

#pragma mark - ChatRequest

typedef GPB_ENUM(ChatRequest_FieldNumber) {
  ChatRequest_FieldNumber_BaseReq = 1,
  ChatRequest_FieldNumber_ZoneId = 10,
  ChatRequest_FieldNumber_LevelId = 11,
  ChatRequest_FieldNumber_TableIndex = 12,
  ChatRequest_FieldNumber_MatchId = 13,
  ChatRequest_FieldNumber_Content = 14,
};

@interface ChatRequest : GPBMessage
